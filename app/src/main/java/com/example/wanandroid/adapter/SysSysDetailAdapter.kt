...
class SysSysDetailAdapter(val children: List<Children>,val lifecycleOwner: LifecycleOwner,val context: Context) :
    ...
    class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindWithId(id: Int,lifecycleOwner: LifecycleOwner,context: Context) {
            val adapter = SysSysItemAdapter()
            val recycleView = itemView.findViewById<RecyclerView>(R.id.recycleView_sys)
